...
class SketchANet(torch.nn.Module):
    def __init__(self, num_classes = 10):
        ...
        self.conv1 = torch.nn.Conv2d(1, 64, (5, 5), stride=1, padding=2)
        self.conv2 = torch.nn.Conv2d(64, 128, (2, 2), stride=1, padding=1)
        ...
        self.conv6 = torch.nn.Conv2d(256, 512, (2, 2), stride=1, padding=0)
